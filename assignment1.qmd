...
Before analysing the pedestrian dataset, I have created 3 helper functions to simplify the 
...
```{python}
#| fig-cap: "Figure 1. Mean hourly pedestrian counts across Auckland CBD. Weekday activity stays above weekend activity for most of the day, especially during typical working hours."
#| fig-align: center
...
```{python}
#| fig-cap: "Figure 2. Average pedestrian counts grouped by day type and rainfall condition. Wet weekdays show a clearer drop than wet weekends."
#| fig-align: center
...
```{python}
#| fig-cap: "Figure 3. The largest weekday–weekend differences across Auckland CBD sensors. Negative values indicate sensors that are busier on weekdays than weekends."
#| fig-align: center
...
![Figure 4. Pedestrian activity pattern across Auckland CBD sensors. Green markers indicate relatively stronger weekday activity, while red markers indicate relatively stronger weekend activity.](/figures/weekday_weekend_map.png)
...
```{python}
#| fig-cap: "Figure 5. Average normalized weekday hourly profiles by sensor cluster. The clusters suggest that different parts of the CBD follow different weekday rhythms."
#| fig-align: center
...
![Figure 6. Sensor clusters across Auckland CBD based on normalized weekday hourly profiles.](figures/sensor_cluster_map.png)
